...
![Hoàng Hôn Chiều Tà (Sunset)](./screenshots/sunset.png)

* **Vị trí ảnh trong repo:** [`docs/screenshots/sunset.png`](./screenshots/sunset.png)
...
![Đêm Tối & Lửa Trại (Night Campfire)](./screenshots/night_campfire.png)

* **Vị trí ảnh trong repo:** [`docs/screenshots/night_campfire.png`](./screenshots/night_campfire.png)
...
![Tính Năng UI: Hòm Thư (Mailbox)](./screenshots/mailbox.png)

* **Vị trí ảnh trong repo:** [`docs/screenshots/mailbox.png`](./screenshots/mailbox.png)
...
![Tính Năng UI: Chế Tạo (Crafting)](./screenshots/crafting.png)

* **Vị trí ảnh trong repo:** [`docs/screenshots/crafting.png`](./screenshots/crafting.png)
